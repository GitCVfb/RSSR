...
class PWCDCNet(nn.Module):
    ...
    def forward(self,im1, im2):        
        ...
        '''
        print(c11.size())#B*16*H/2*W/2
        print(c12.size())#B*32*H/4*W/4
        print(c13.size())#B*64*H/8*W/8
        print(c14.size())#B*96*H/16*W/16
        print(c15.size())#B*128*H/32*W/32
        print(c16.size())#B*196*H/64*W/64
        '''
        ...
        return flow2,flow3,flow4,flow5,flow6 #, c21,c22,c23#for image decoder
